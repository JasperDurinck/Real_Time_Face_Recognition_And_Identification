...
from Image_Confidance_function import Face_ID_combined_Tensor
...
list_perons_embedding, name_list, list_normilizers, list_tensors_per_ID, list_Condifance_Threshold_list = Face_ID_combined_Tensor(load_data)

print(list_Condifance_Threshold_list)

#edit the list_Condifance_Threshold_list to customize
#list_Condifance_Threshold_list = [3.5, 3.5, 3.4, 3.4, 3.7]
...
def Win32Cap_Screen_Cap_Detect():
    ...
    prob_threshold = 0.9 #Threshold (needs to be greater than #prob_thershold) for the probability of a face being in a frame (says nothing about person recongization)
    min_dist_threshold = 0 #Threshold for the min_dist for which a name is assignt to the face (min_dist must be lower than min_dist_threshold)
